    ...
    <script type="text/javascript">
        ...
        function modifyPassword() {
            ...
            if (newPassword == null || newPassword == "") {
                $.messager.alert("系统提示", "请填写新密码！");
            } else if (newPassword2 == null || newPassword2 == "") {
                $.messager.alert("系统提示", "请填写确认密码！");
            } else if (newPassword != newPassword2) {
                $.messager.alert("系统提示", "请检查确认密码！");
            } else {
                $("#fm").form("submit", {
                    url: url,
                    onSubmit: function () {
        ...
        function refreshSystem() {
            $.post("${pageContext.request.contextPath}/admin/system/refreshSystem.do?" + Math.random(), {}, function (result) {
                if (result) {
        ...
        function logout() {
            $.messager.confirm("安全退出", "你确定要退出系统吗?", function (r) {
                if (r) {
