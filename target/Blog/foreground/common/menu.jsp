            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="${pageContext.request.contextPath}/blogger/download.html"><font
                                color="black"><strong>本站源码下载</strong></font></a></li>
                    </ul>
                    <form onsubmit="return checkData()" action="${pageContext.request.contextPath}/blog/search.do" class="navbar-form navbar-right"
                          role="search">
